...
#include "../common/decodepts.hpp"
#include "../common/filetypebox.hpp"
...
#include "../common/imagespatialextentsproperty.hpp"
...
namespace HEIF
{
    ...
    private:
        ...
        struct ImageInfo
        {
            FourCC type;               ///< Image type from Item Information box
        ...
        struct ItemInfo
        {
            FourCC type;  ///< Item type from Item Information box
        };
         ...
         * @return Filled MetaBoxProperties */
        MetaBoxFeature extractMetaBoxFeatures(const ImageFeaturesMap& imageFeatures, const Groupings& groupings) const;
        ...
        Array<SampleGrouping> getSampleGroupings(TrackBox* trackBox) const;
